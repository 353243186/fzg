...
extension UIColor {
    /**
     ...
     - parameter alpha      b: 透明度，默认为1，不透明
     - returns: RGB
     */
    //    static var blue1
    ...
    static var black333 : UIColor {
        return withHex(hexInt: 0x333333)
    }
    
    static var black666 : UIColor {
        return withHex(hexInt: 0x666666)
    }

    static var black999 : UIColor {
        return withHex(hexInt: 0x999999)
    }
    static var blackccc : UIColor {
        return withHex(hexInt: 0xcccccc)
    }
